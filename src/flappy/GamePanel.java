...
public class GamePanel extends JPanel {
    ...
    public GamePanel(Flappy fb, Bird bird, ArrayList<Rectangle> rects) {
        this.fb = fb;
        this.bird = bird;
        this.rects = rects;
    ...
    public void paintComponent(Graphics g) {
        ...
        if(fb.paused()) {
            ...
            g.drawString("PAUSED", Flappy.WIDTH/2-100, Flappy.HEIGHT/2-100);
            g.drawString("PRESS SPACE TO BEGIN", Flappy.WIDTH/2-300, Flappy.HEIGHT/2+50);
        }
    }
}
